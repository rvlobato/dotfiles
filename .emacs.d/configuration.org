...
;(require 'git-commit)
;(server-mode)
(load "~/.emacs.d/elpa/magit-4.1.2/magit-autoloads.el")
  #+END_SRC
...
(use-package eglot-ltex
  :hook
  ((org-mode text-mode latex-mode git-commit-major-mode) . (lambda ()
							     (require 'eglot-ltex)
							     (eglot-ensure)
							     )
   )
:init
(setq eglot-ltex-server-path "~/.emacs.d/ltex/ltex-ls-16.0.0"
