...
Pkg.add("ComponentArrays") # Arrays with arbitrarily nested named components.
...
Pkg.add("DiffEqParamEstim") # Easy scientific machine learning (SciML) parameter estimation with pre-built loss functions
Pkg.add("DifferentialEquations")
Pkg.add("Distributed")
Pkg.add("Distributions")
Pkg.add("Flux") # The Julia Machine Learning Library
Pkg.add("ForwardDiff") # Forward Mode Automatic Differentiation for Julia
...
Pkg.add("Optimization") # Mathematical Optimization in Julia. Local, global, gradient-based and derivative-free.
Pkg.add("OptimizationBBO") # Mathematical Optimization in Julia. Local, global, gradient-based and derivative-free. Linear, Quadratic, Convex, Mixed-Integer, and Nonlinear Optimization in one simple, fast, and differentiable interface.
Pkg.add("OptimizationOptimJL")
Pkg.add("OptimizationOptimisers") # Optimization packages
Pkg.add("OrdinaryDiffEq") # High performance ordinary differential equation (ODE) and differential-algebraic equation (DAE) solvers, including neural ordinary differential equations (neural ODEs) and scientific machine learning (SciML)
Pkg.add("Plots")
Pkg.add("Pluto")
Pkg.add("PyCall")
Pkg.add("PyPlot")
Pkg.add("RCall")
Pkg.add("RecursiveArrayTools") # Tools for easily handling objects like arrays of arrays and deeper nestings in scientific machine learning (SciML) and other applications
